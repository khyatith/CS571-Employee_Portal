...
var str7=document.getElementById("orderstartdate").value;
var str8=document.getElementById("orderenddate").value;
var sale1="?select="+str1;
sale1+="&pname="+str2+"&fprice="+str3+"&toprice="+str4+"&stdate="+str5+"&endate="+str6+"&orderstartdate="+str7+"&orderenddate="+str8;
...
{
xmlhttp.open("GET","viewSalesOrderReport1.php?"+sale1,true);

}
else
{
xmlhttp.open("GET","viewSalesOrderReport1.php?select="+str1,true);
}
xmlhttp.send();
...
<div id="Header">
<h3 style="font-family:'Times New Roman';font-size:26pt;color:#FF9900">Search Orders From SpecialSale</h3>
<form name="form1">
<table>
<tr>
...
<td><input type="text" value="" id="orderstartdate" placeholder="Order Start Date" /></td>
<td><input type="text" value="" id="orderenddate" placeholder="Order End Date" /></td>
</tr>
</table>
<br/><br/>

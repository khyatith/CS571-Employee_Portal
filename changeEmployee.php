...
{
//echo "$row[$i]";
$query="DELETE FROM users where e_id= '$row[$i]'";
...
echo "<div id='Header'><h3 style='font-family:'Times New Roman';font-size:26pt;color:#FF9900'>DELETE EMPLOYEE</h3></div>";
...
<form method="post" action="changeEmployee.php">
<div id="Header">
